...
// mtxcbind
/**  * Combine matrices column-wise  *   * This is an internal function used within the package.  * @keywords internal  */ NumericMatrix mtxcbind(NumericMatrix a, NumericMatrix b);
