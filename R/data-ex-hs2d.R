...
#' domain triangulated into 84 triangles and the target surface \eqn{m_3},
#' generated by \code{mgcv::fs.test(z1, z2)}.
#'
...
#' surface \eqn{m_3} as \code{ex_hs2d_train}, where \eqn{m_3} is generated by
#' \code{mgcv::fs.test(z1, z2)}.
#'
