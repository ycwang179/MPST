#' Multivariate Penalized Spline over Triangulation Model Fitting using Distributed Method
#'
#' This function conducts the model fitting for multivariate penlized spline over triangulation using distributive method.
#'
